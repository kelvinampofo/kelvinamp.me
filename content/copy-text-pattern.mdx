...
That's about it. Open for extension, closed for modification. You can find the full code [here](https://github.com/kelvinampofo/kelvinamp.me/blob/main/src/components/CopyLinkButton.tsx).
