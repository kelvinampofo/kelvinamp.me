...
return (
  <Tooltip content="Copy URL">
    <button onClick={handleCopyUrl} aria-label={copied ? 'Copied URL' : 'Copy URL'}>
...
That's about it. Open for extension, closed for modification. You can find the full code [here](https://github.com/kelvinampofo/kelvinamp.me/blob/main/src/app/components/CopyLinkButton.tsx).
