...
import TimelinePicker from "../../craft/prototypes/timeline-picker/TimelinePicker";
  ...
  return (
    <>
      ...
      <p>
        ...
        the interface’s{" "}
        <a href="https://en.wikipedia.org/wiki/Affordance">affordance</a>.
        Simply an invisible <code>::after</code> pseudo-element with added
