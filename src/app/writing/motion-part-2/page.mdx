...
Most UI animations should live between 200–300ms.<sup className="prose-sup"><a href="#fn-1">1</a></sup> This range feels quick, yet readable from a cognitive standpoint. It gives the eye just enough time to register change, without making the interface feel slow.
...
- Function over flourish. Motion should never block comprehension or speed.<sup className="prose-sup"><a href="#fn-3">3</a></sup>
...
Animation is a tool for _storytelling_ but it requires taste&mdash;knowing when to hold back. I find that interfaces that feel <q>alive</q> usually reflect careful choices—balancing responsiveness with restraint.
