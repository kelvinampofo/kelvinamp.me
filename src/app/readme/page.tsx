    ...
    <>
      ...
      <article className="prose layout-main">
        ...
        <ul className="prose-list">
          ...
          <ul className="prose-list">
            <li>
              I keep core hours open for sync and protect deep-work blocks most
              mornings. My calendar is the source of truth.
            </li>
          </ul>
          ...
          <li>Working with ADHD</li>
          <ul className="prose-list">
            <li>
              I have ADHD. Clear, prioritised asks with scope and deadlines help
              me deliver. Written follow-ups make a difference.
            </li>
            <li>
        ...
        <ul className="prose-list">
          ...
          <ul className="prose-list">
            <li>
              ...
              transitions, and recovery. Define what’s optimistic vs. confirmed.
            </li>
            <li>
