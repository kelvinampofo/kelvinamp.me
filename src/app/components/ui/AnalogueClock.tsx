...
export default function AnalogClock() {
  ...
  return (
    <div className="relative inline-flex size-5 rounded-full border border-secondary dark:border-[#a0a0a0]">
      <div
        className="absolute left-1/2 top-[6.1px] z-10 ml-[-0.25px] h-1 w-px bg-secondary dark:bg-secondary-dark"
        style={{
