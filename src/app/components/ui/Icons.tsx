...
export function ChevronLeftIcon({ className, height = 15, width = 15, ariaLabel }: IconProps) {
  return (
    <svg
      className={className}
      height={height}
...
export function ChevronRightIcon({ className, height = 15, width = 15, ariaLabel }: IconProps) {
  return (
    <svg
      className={className}
      height={height}
