...
/**
 * Wires canvas pointer and wheel gestures into pan/zoom state updates.
 *
 * @param options refs and callbacks sourced from the viewport hook.
 * @returns pointer handlers for the canvas element.
 */
