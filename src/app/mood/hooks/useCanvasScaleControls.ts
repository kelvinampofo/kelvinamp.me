...
/**
 * Encapsulates zoom state, clamping, and helpers for the mood canvas.
 *
 * @param options configuration linking DOM refs and behaviour constraints.
 * @returns scale state/ref plus imperative zoom utilities.
 */
