      ...
      {isPointerDevice && (
        <div className="flex items-center">
          <button
            ...
            className={c(
              'mr-2 rounded-sm text-primary duration-150 dark:border-neutral-800 dark:text-primary-dark disabled:cursor-not-allowed disabled:text-neutral-300 dark:disabled:text-neutral-600 dark:hover:bg-[#404040] dark:disabled:bg-transparent hover:bg-neutral-200 disabled:bg-transparent'
            )}
          >
      ...
      {isPointerDevice && (
        <div className="flex items-center">
          <button
            ...
            className={c(
              'ml-2 rounded-sm text-primary duration-150 dark:border-neutral-800 dark:text-primary-dark disabled:cursor-not-allowed dark:disabled:text-neutral-600 dark:hover:bg-[#404040] dark:disabled:bg-transparent hover:bg-neutral-200 disabled:bg-transparent'
            )}
          >
