      ...
      {isPointerDevice && (
        <div className="flex items-center">
          <button
            ...
            className={c(
              'mr-2 rounded-sm text-secondary duration-150 dark:border-neutral-800 dark:text-secondary-dark disabled:cursor-not-allowed disabled:text-neutral-300 dark:disabled:text-neutral-600 dark:hover:text-primary-dark hover:text-primary'
            )}
          >
      ...
      {isPointerDevice && (
        <div className="flex items-center">
          <button
            ...
            className={c(
              'ml-2 rounded-sm text-secondary duration-150 dark:border-neutral-800 dark:text-secondary-dark disabled:cursor-not-allowed disabled:text-neutral-300 dark:disabled:text-neutral-600 dark:hover:text-primary-dark hover:text-primary'
            )}
          >
