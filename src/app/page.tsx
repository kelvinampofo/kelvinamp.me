  ...
  return (
    <section className="flex flex-col justify-center px-8 py-12 md:py-32 lg:px-10 lg:py-32">
      ...
      <section>
        <Link
          href="/now"
          className="mt-6 inline-flex items-center underline decoration-neutral-500 decoration-1 underline-offset-4 duration-500 ease-in-out hover:text-gray-500"
          aria-label="Go to now page"
        >
          Now
          <ArrowTopRightIcon aria-label="Arrow icon" />
        </Link>
      </section>
